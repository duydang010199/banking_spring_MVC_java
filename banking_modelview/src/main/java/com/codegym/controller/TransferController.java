...
public class TransferController {
    ...
    public ModelAndView transferCustomer(@PathVariable long senderId,
        ...
        if (recipient == null) {
            ...
            modelAndView.addObject("errorAction", "Người nhận không tồn tại!");
            return modelAndView;
        }
        ...
        if (currentBalanceSender.compareTo(transactionAmount) < 0) {
            ...
            modelAndView.addObject("sender", sender);
            modelAndView.addObject("recipients", recipients);
            modelAndView.addObject("errorAction", "Số dư không đủ để thực hiện giao dịch!");
            modelAndView.setViewName("transfer/create");
            return modelAndView;
        }
